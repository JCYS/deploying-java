...
/**
* Implementación del service para SvSolicitudVisitaTipoActividadAltoRiesgoEntity
* Extiende de las implementaciones especializadas para reutilizar funcionalidad
*/
@Slf4j
@Service
@RequiredArgsConstructor
public class SvSolicitudVisitaTipoActividadAltoRiesgoService implements ISvSolicitudVisitaTipoActividadAltoRiesgoService {
