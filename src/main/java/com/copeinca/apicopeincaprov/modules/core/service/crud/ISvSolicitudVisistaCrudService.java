...
/**
* Interface de servicio CRUD para SvSolicitudVisistaEntity
* Responsable de las operaciones básicas de creación, actualización y eliminación.
*/
public interface ISvSolicitudVisistaCrudService {

    /**
    * Guarda (crea o actualiza) la entidad a partir del DTO.
    */
    SvSolicitudVisistaEntity save(SvSolicitudVisistaDTO dto);
    ...
    */
    List<SvSolicitudVisistaEntity> saveAll(List<SvSolicitudVisistaDTO> dtos);
}
