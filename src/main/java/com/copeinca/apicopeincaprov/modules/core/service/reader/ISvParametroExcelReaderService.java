...
/**
* Interface de servicio para lectura de archivos de SvParametroEntity
*/
public interface ISvParametroExcelReaderService {

    /**
    * Leer datos desde archivo CSV.
    */
    List<SvParametroDTO> readFromCsv(InputStream inputStream);

    /**
    * Leer datos desde archivo Excel.
    */
    List<SvParametroDTO> readFromExcel(InputStream inputStream) throws IOException;
}
