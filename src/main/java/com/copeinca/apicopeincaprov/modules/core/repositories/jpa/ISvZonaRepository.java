...
/**
* Repository para SvZonaEntity
*/
@Repository
public interface ISvZonaRepository extends JpaRepository<SvZonaEntity, String>, JpaSpecificationExecutor<SvZonaEntity> {

    @Modifying
    @Transactional
    @Query("UPDATE SvZonaEntity o SET o.isDeleted = :isDeleted WHERE o.id = :id")
    int updateIsDeleted(@Param("isDeleted") boolean isDeleted, @Param("id") String id);

    List<SvZonaEntity> findByNameAndSedeId(String name, String sedeId);
}
