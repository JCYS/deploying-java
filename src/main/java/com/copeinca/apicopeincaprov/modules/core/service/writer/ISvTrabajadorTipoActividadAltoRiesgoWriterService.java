...
/**
* Interface de servicio para escritura de archivos de SvTrabajadorTipoActividadAltoRiesgoEntity
*/
public interface ISvTrabajadorTipoActividadAltoRiesgoWriterService extends IDefineColumnReport<SvTrabajadorTipoActividadAltoRiesgoDTO> {

    /**
    * Generar archivo CSV a partir de una lista de datos.
    */
    AttachmentData exportToCsv(List<SvTrabajadorTipoActividadAltoRiesgoDTO> data);

    /**
    * Generar archivo Excel a partir de una lista de datos.
    */
    AttachmentData exportToExcel(List<SvTrabajadorTipoActividadAltoRiesgoDTO> data) throws Exception;
}
