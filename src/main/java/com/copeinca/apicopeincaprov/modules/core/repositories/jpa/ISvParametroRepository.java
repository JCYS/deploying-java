...
/**
* Repository para SvParametroEntity
*/
@Repository
public interface ISvParametroRepository extends JpaRepository<SvParametroEntity, String>, JpaSpecificationExecutor<SvParametroEntity> {

    @Modifying
    @Transactional
    @Query("UPDATE SvParametroEntity o SET o.isDeleted = :isDeleted WHERE o.id = :id")
