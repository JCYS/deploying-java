...
/**
* Implementación del service para SvSolicitudVisitaMaterialEntity
* Extiende de las implementaciones especializadas para reutilizar funcionalidad
*/
@Slf4j
@Service
@RequiredArgsConstructor
public class SvSolicitudVisitaMaterialService implements ISvSolicitudVisitaMaterialService {
