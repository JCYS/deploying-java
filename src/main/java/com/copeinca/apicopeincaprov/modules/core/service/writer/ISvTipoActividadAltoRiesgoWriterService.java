...
/**
* Interface de servicio para escritura de archivos de SvTipoActividadAltoRiesgoEntity
*/
public interface ISvTipoActividadAltoRiesgoWriterService extends IDefineColumnReport<SvTipoActividadAltoRiesgoDTO> {

    /**
    * Generar archivo CSV a partir de una lista de datos.
    */
    AttachmentData exportToCsv(List<SvTipoActividadAltoRiesgoDTO> data);

    /**
    * Generar archivo Excel a partir de una lista de datos.
    */
    AttachmentData exportToExcel(List<SvTipoActividadAltoRiesgoDTO> data) throws Exception;
}
