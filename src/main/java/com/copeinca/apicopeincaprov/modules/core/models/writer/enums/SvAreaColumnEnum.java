...
/**
* Enum que mapea las columnas del DTO SvAreaDTO con sus índices.
* Utilizado para lectura de archivos CSV y Excel.
*/
@RequiredArgsConstructor
public enum SvAreaColumnEnum implements IExcelColumnPropertiesEnum {

    AREA_ID(0, "AREA_ID", 400), //
    NAME(1, "NAME", 400), //
    AMBITO(2, "AMBITO", 400), //
    OPERATIVA(3, "OPERATIVA", 400), //
    SEDE_ID(4, "SEDE_ID", 400), //
