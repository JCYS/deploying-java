...
@Entity
@Table(name = "SV_TIPO_DOCUMENTO_IDENTIDAD")
public class SvTipoDocumentoIdentidadEntity extends BaseEntity implements Serializable {
    ...
    @Size(max = 100)
    @Column(name = "EXPRESION_REGULAR", length = 100)
