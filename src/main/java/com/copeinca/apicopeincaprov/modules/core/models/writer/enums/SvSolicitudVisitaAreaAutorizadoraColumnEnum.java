...
/**
* Enum que mapea las columnas del DTO SvSolicitudVisitaAreaAutorizadoraDTO con sus índices.
* Utilizado para lectura de archivos CSV y Excel.
*/
@RequiredArgsConstructor
public enum SvSolicitudVisitaAreaAutorizadoraColumnEnum implements IExcelColumnPropertiesEnum {

    SOLICITUD_VISITA_AREA_AUTORIZADORA_ID(0, "SOLICITUD_VISITA_AREA_AUTORIZADORA_ID", 400), //
    IS_ACTIVE(1, "IS_ACTIVE", 400), //
    SOLICITUD_VISITA_ID(2, "SOLICITUD_VISITA_ID", 400), //
    AREA_AUTORIZADORA_ID(3, "AREA_AUTORIZADORA_ID", 400), //
