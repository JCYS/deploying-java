...
/**
* Implementación del service para SvEstadoCalidadAmbientalEntity
* Extiende de las implementaciones especializadas para reutilizar funcionalidad
*/
@Slf4j
@Service
@RequiredArgsConstructor
public class SvEstadoCalidadAmbientalService implements ISvEstadoCalidadAmbientalService {
