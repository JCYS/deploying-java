...
/**
* Enum que mapea las columnas del DTO SvUsuarioDTO con sus índices.
* Utilizado para lectura de archivos CSV y Excel.
*/
@RequiredArgsConstructor
public enum SvUsuarioColumnEnum implements IExcelColumnPropertiesEnum {

    USUARIO_ID(0, "USUARIO_ID", 400), //
    NOMBRE(1, "NOMBRE", 400), //
    APELLIDOS(2, "APELLIDOS", 400), //
    EMAIL(3, "EMAIL", 400), //
    IDENTIFICADOR_EXTERNO(4, "IDENTIFICADOR_EXTERNO", 400), //
