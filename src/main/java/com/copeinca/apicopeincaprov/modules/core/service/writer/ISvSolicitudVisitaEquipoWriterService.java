...
/**
* Interface de servicio para escritura de archivos de SvSolicitudVisitaEquipoEntity
*/
public interface ISvSolicitudVisitaEquipoWriterService extends IDefineColumnReport<SvSolicitudVisitaEquipoDTO> {

    /**
    * Generar archivo CSV a partir de una lista de datos.
    */
    AttachmentData exportToCsv(List<SvSolicitudVisitaEquipoDTO> data);

    /**
    * Generar archivo Excel a partir de una lista de datos.
    */
    AttachmentData exportToExcel(List<SvSolicitudVisitaEquipoDTO> data) throws Exception;
}
