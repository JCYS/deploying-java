...
/**
* Enum que mapea las columnas del DTO SvProveedorSedeDTO con sus índices.
* Utilizado para lectura de archivos CSV y Excel.
*/
@RequiredArgsConstructor
public enum SvProveedorSedeColumnEnum implements IExcelColumnPropertiesEnum {

    PROVEEDOR_SEDE_ID(0, "PROVEEDOR_SEDE_ID", 400), //
    PROVEEDOR_ID(1, "PROVEEDOR_ID", 400), //
    SEDE_ID(2, "SEDE_ID", 400), //
