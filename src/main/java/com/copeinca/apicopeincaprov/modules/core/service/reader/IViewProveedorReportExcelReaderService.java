...
/**
* Interface de servicio para lectura de archivos de ViewProveedorReportView
*/
public interface IViewProveedorReportExcelReaderService {

    /**
    * Leer datos desde archivo CSV.
    */
    List<ViewProveedorReportDTO> readFromCsv(InputStream inputStream);

    /**
    * Leer datos desde archivo Excel.
    */
    List<ViewProveedorReportDTO> readFromExcel(InputStream inputStream) throws IOException;
}
