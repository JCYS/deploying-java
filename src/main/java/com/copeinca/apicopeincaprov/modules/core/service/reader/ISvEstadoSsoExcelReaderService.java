...
/**
* Interface de servicio para lectura de archivos de SvEstadoSsoEntity
*/
public interface ISvEstadoSsoExcelReaderService {

    /**
    * Leer datos desde archivo CSV.
    */
    List<SvEstadoSsoDTO> readFromCsv(InputStream inputStream);

    /**
    * Leer datos desde archivo Excel.
    */
    List<SvEstadoSsoDTO> readFromExcel(InputStream inputStream) throws IOException;
}
