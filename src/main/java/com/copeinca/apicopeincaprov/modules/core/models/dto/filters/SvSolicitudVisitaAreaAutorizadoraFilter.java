...
/**
 * DTO filtro para búsquedas dinámicas de SvSolicitudVisitaAreaAutorizadora.
...
@NoArgsConstructor
@AllArgsConstructor
public class SvSolicitudVisitaAreaAutorizadoraFilter implements Serializable {
    ...
    */
    ...
    /**
    * Filtro por lista de IDs para FK nativa: areaAutorizadoraId.
    * Filtro directo por identificadores sin operadores complejos.
    */
    private List<String> areaAutorizadoraIdIds;
