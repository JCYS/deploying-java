...
/**
* Interface de servicio para lectura de archivos de SvPersonalEntity
*/
public interface ISvPersonalExcelReaderService {

    /**
    * Leer datos desde archivo CSV.
    */
    List<SvPersonalDTO> readFromCsv(InputStream inputStream);

    /**
    * Leer datos desde archivo Excel.
    */
    List<SvPersonalDTO> readFromExcel(InputStream inputStream) throws IOException;
}
