...
/**
* Interface de servicio para escritura de archivos de SvTipoDocumentoIdentidadEntity
*/
public interface ISvTipoDocumentoIdentidadWriterService extends IDefineColumnReport<SvTipoDocumentoIdentidadDTO> {

    /**
    * Generar archivo CSV a partir de una lista de datos.
    */
    AttachmentData exportToCsv(List<SvTipoDocumentoIdentidadDTO> data);

    /**
    * Generar archivo Excel a partir de una lista de datos.
    */
    AttachmentData exportToExcel(List<SvTipoDocumentoIdentidadDTO> data) throws Exception;
}
