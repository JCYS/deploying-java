...
/**
* Enum que mapea las columnas del DTO SvEstadoSolicitudVisitaDTO con sus índices.
* Utilizado para lectura de archivos CSV y Excel.
*/
@RequiredArgsConstructor
public enum SvEstadoSolicitudVisitaColumnEnum implements IExcelColumnPropertiesEnum {

    ESTADO_SOLICITUD_VISITA_CODE(0, "ESTADO_SOLICITUD_VISITA_CODE", 400), //
    NAME(1, "NAME", 400), //
