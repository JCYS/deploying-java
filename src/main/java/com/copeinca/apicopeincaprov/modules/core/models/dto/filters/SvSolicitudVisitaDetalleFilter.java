...
/**
 * DTO filtro para búsquedas dinámicas de SvSolicitudVisitaDetalle.
...
@NoArgsConstructor
@AllArgsConstructor
public class SvSolicitudVisitaDetalleFilter implements Serializable {

    private List<FilterOperation<String>> id;
    private List<FilterOperation<String>> proveedorComentario;
