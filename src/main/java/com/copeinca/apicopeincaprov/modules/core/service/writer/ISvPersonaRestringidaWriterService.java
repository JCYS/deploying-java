...
/**
* Interface de servicio para escritura de archivos de SvPersonaRestringidaEntity
*/
public interface ISvPersonaRestringidaWriterService extends IDefineColumnReport<SvPersonaRestringidaDTO> {

    /**
    * Generar archivo CSV a partir de una lista de datos.
    */
    AttachmentData exportToCsv(List<SvPersonaRestringidaDTO> data);

    /**
    * Generar archivo Excel a partir de una lista de datos.
    */
    AttachmentData exportToExcel(List<SvPersonaRestringidaDTO> data) throws Exception;
}
