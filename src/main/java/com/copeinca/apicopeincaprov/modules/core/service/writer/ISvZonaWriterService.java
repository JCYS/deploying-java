...
/**
* Interface de servicio para escritura de archivos de SvZonaEntity
*/
public interface ISvZonaWriterService extends IDefineColumnReport<SvZonaDTO> {

    /**
    * Generar archivo CSV a partir de una lista de datos.
    */
    AttachmentData exportToCsv(List<SvZonaDTO> data);

    /**
    * Generar archivo Excel a partir de una lista de datos.
    */
    AttachmentData exportToExcel(List<SvZonaDTO> data) throws Exception;
}
