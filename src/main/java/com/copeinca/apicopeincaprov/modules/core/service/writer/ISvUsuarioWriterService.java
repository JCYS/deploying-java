...
/**
* Interface de servicio para escritura de archivos de SvUsuarioEntity
*/
public interface ISvUsuarioWriterService extends IDefineColumnReport<SvUsuarioDTO> {

    /**
    * Generar archivo CSV a partir de una lista de datos.
    */
    AttachmentData exportToCsv(List<SvUsuarioDTO> data);

    /**
    * Generar archivo Excel a partir de una lista de datos.
    */
    AttachmentData exportToExcel(List<SvUsuarioDTO> data) throws Exception;
}
