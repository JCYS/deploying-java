...
/**
* Interface de servicio para escritura de archivos de ViewTrabajadorReportView
*/
public interface IViewTrabajadorReportWriterService extends IDefineColumnReport<ViewTrabajadorReportDTO> {

    /**
    * Generar archivo CSV a partir de una lista de datos.
    */
    AttachmentData exportToCsv(List<ViewTrabajadorReportDTO> data);

    /**
    * Generar archivo Excel a partir de una lista de datos.
    */
    AttachmentData exportToExcel(List<ViewTrabajadorReportDTO> data) throws Exception;
}
