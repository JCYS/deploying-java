...
/**
* Repository para SvUsuarioEntity
*/
@Repository
public interface ISvUsuarioRepository extends JpaRepository<SvUsuarioEntity, String>, JpaSpecificationExecutor<SvUsuarioEntity> {

    @Modifying
    @Transactional
    @Query("UPDATE SvUsuarioEntity o SET o.isDeleted = :isDeleted WHERE o.id = :id")
    int updateIsDeleted(@Param("isDeleted") boolean isDeleted, @Param("id") String id);

    List<SvUsuarioEntity> findAllByEmail(String email);
}
