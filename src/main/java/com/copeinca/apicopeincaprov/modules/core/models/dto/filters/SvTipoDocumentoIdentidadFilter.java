...
/**
 * DTO filtro para búsquedas dinámicas de SvTipoDocumentoIdentidad.
...
@NoArgsConstructor
@AllArgsConstructor
public class SvTipoDocumentoIdentidadFilter implements Serializable {
    ...
    private List<FilterOperation<String>> expresionRegular;
