...
/**
* Interface de servicio para escritura de archivos de SvEstadoSolicitudVisitaEntity
*/
public interface ISvEstadoSolicitudVisitaWriterService extends IDefineColumnReport<SvEstadoSolicitudVisitaDTO> {

    /**
    * Generar archivo CSV a partir de una lista de datos.
    */
    AttachmentData exportToCsv(List<SvEstadoSolicitudVisitaDTO> data);

    /**
    * Generar archivo Excel a partir de una lista de datos.
    */
    AttachmentData exportToExcel(List<SvEstadoSolicitudVisitaDTO> data) throws Exception;
}
