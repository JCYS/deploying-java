...
import com.copeinca.apicopeincaprov.modules.core.models.entities.SvEstadoCalidadAmbientalEntity_;
...
/**
 * Specification para búsqueda dinámica de SvEstadoCalidadAmbientalEntity.
 * Extiende de AbstractSpecification para reutilizar lógica común de filtros.
 */
public class SvEstadoCalidadAmbientalSpecification extends AbstractSpecification {
     ...
     */
    public static Specification<SvEstadoCalidadAmbientalEntity> byFilter(SvEstadoCalidadAmbientalFilter filter) {

        return (Root<SvEstadoCalidadAmbientalEntity> root, CriteriaQuery<?> query, CriteriaBuilder cb) -> {

            List<Predicate> predicates = new ArrayList<>();

            //--- Filtro dinámico para id
            addPredicates(predicates, cb, root, SvEstadoCalidadAmbientalEntity_.id, filter.getId());

            //--- Filtro dinámico para name
            addPredicates(predicates, cb, root, SvEstadoCalidadAmbientalEntity_.name, filter.getName());

            //--- Filtro dinámico para description
            addPredicates(predicates, cb, root, SvEstadoCalidadAmbientalEntity_.description, filter.getDescription());
