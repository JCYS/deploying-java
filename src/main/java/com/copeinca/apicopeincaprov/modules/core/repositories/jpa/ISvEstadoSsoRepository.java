...
/**
* Repository para SvEstadoSsoEntity
*/
@Repository
public interface ISvEstadoSsoRepository extends JpaRepository<SvEstadoSsoEntity, String>, JpaSpecificationExecutor<SvEstadoSsoEntity> {

    @Modifying
    @Transactional
    @Query("UPDATE SvEstadoSsoEntity o SET o.isDeleted = :isDeleted WHERE o.id = :id")
