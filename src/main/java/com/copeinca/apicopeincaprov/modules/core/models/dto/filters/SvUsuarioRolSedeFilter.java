...
/**
 * DTO filtro para búsquedas dinámicas de SvUsuarioRolSede.
...
@NoArgsConstructor
@AllArgsConstructor
public class SvUsuarioRolSedeFilter implements Serializable {
    ...
    /**
    * Filtro por lista de IDs para FK nativa: usuarioId.
    * Filtro directo por identificadores sin operadores complejos.
    */
    private List<String> usuarioIdIds;

    /**
    * Filtro por lista de IDs para FK nativa: rolCode.
    * Filtro directo por identificadores sin operadores complejos.
    */
    private List<String> rolCodeIds;
