...
/**
* Interface de servicio para lectura de archivos de SvZonaEntity
*/
public interface ISvZonaExcelReaderService {

    /**
    * Leer datos desde archivo CSV.
    */
    List<SvZonaDTO> readFromCsv(InputStream inputStream);

    /**
    * Leer datos desde archivo Excel.
    */
    List<SvZonaDTO> readFromExcel(InputStream inputStream) throws IOException;
}
