...
/**
* Interface de servicio CRUD para SvEstadoCalidadAmbientalEntity
* Responsable de las operaciones básicas de creación, actualización y eliminación.
*/
public interface ISvEstadoCalidadAmbientalCrudService {

    /**
    * Guarda (crea o actualiza) la entidad a partir del DTO.
    */
    SvEstadoCalidadAmbientalEntity save(SvEstadoCalidadAmbientalDTO dto);
    ...
    */
    List<SvEstadoCalidadAmbientalEntity> saveAll(List<SvEstadoCalidadAmbientalDTO> dtos);
}
