...
/**
 * DTO filtro para búsquedas dinámicas de SvSolicitudVisitaZona.
...
@NoArgsConstructor
@AllArgsConstructor
public class SvSolicitudVisitaZonaFilter implements Serializable {
    ...
    /**
    * Filtro por lista de IDs para FK nativa: zonaId.
    * Filtro directo por identificadores sin operadores complejos.
    */
    private List<String> zonaIdIds;
