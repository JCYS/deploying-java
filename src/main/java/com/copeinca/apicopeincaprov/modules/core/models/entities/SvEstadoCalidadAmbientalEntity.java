...
@Entity
@Table(name = "SV_ESTADO_CALIDAD_AMBIENTAL")
public class SvEstadoCalidadAmbientalEntity extends BaseEntity implements Serializable {
    ...
    @NotEmpty
    @Size(max = 20)
    @Column(name = "ESTADO_CALIDAD_AMBIENTAL_CODE", length = 20)
    @Id
    private String id;
