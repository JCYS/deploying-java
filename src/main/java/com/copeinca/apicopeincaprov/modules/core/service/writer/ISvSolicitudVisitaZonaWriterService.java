...
/**
* Interface de servicio para escritura de archivos de SvSolicitudVisitaZonaEntity
*/
public interface ISvSolicitudVisitaZonaWriterService extends IDefineColumnReport<SvSolicitudVisitaZonaDTO> {

    /**
    * Generar archivo CSV a partir de una lista de datos.
    */
    AttachmentData exportToCsv(List<SvSolicitudVisitaZonaDTO> data);

    /**
    * Generar archivo Excel a partir de una lista de datos.
    */
    AttachmentData exportToExcel(List<SvSolicitudVisitaZonaDTO> data) throws Exception;
}
