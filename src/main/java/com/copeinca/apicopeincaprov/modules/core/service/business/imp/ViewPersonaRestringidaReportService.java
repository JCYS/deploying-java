...
/**
* Implementación del service para ViewPersonaRestringidaReportView
* Extiende de las implementaciones especializadas para reutilizar funcionalidad
*/
@Slf4j
@Service
@RequiredArgsConstructor
public class ViewPersonaRestringidaReportService implements IViewPersonaRestringidaReportService {
