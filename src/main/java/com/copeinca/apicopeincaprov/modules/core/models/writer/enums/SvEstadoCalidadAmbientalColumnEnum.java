...
/**
* Enum que mapea las columnas del DTO SvEstadoCalidadAmbientalDTO con sus índices.
* Utilizado para lectura de archivos CSV y Excel.
*/
@RequiredArgsConstructor
public enum SvEstadoCalidadAmbientalColumnEnum implements IExcelColumnPropertiesEnum {

    ESTADO_CALIDAD_AMBIENTAL_CODE(0, "ESTADO_CALIDAD_AMBIENTAL_CODE", 400), //
    NAME(1, "NAME", 400), //
