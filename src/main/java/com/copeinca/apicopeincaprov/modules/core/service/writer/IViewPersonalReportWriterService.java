...
/**
* Interface de servicio para escritura de archivos de ViewPersonalReportView
*/
public interface IViewPersonalReportWriterService extends IDefineColumnReport<ViewPersonalReportDTO> {

    /**
    * Generar archivo CSV a partir de una lista de datos.
    */
    AttachmentData exportToCsv(List<ViewPersonalReportDTO> data);

    /**
    * Generar archivo Excel a partir de una lista de datos.
    */
    AttachmentData exportToExcel(List<ViewPersonalReportDTO> data) throws Exception;
}
