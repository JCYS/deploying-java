...
@Entity
@Table(name = "SV_SOLICITUD_VISITA_AREA_AUTORIZADORA")
public class SvSolicitudVisitaAreaAutorizadoraEntity extends BaseEntity implements Serializable {

    // -----------------------------------------------------------------
    // Attributes
    // -----------------------------------------------------------------

    @Column(name = "SOLICITUD_VISITA_AREA_AUTORIZADORA_ID", length = 36)
    ...
    @Column(name = "AREA_AUTORIZADORA_ID", nullable = false, length = 36)
    ...
    @JoinColumn(name = "AREA_AUTORIZADORA_ID", nullable = false, insertable = false, updatable = false)
    @ManyToOne
    private SvAreaEntity areaAutorizadoraIDEntity;
