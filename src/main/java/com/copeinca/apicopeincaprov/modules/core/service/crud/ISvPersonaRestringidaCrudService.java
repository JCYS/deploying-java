...
/**
* Interface de servicio CRUD para SvPersonaRestringidaEntity
* Responsable de las operaciones básicas de creación, actualización y eliminación.
*/
public interface ISvPersonaRestringidaCrudService {

    /**
    * Guarda (crea o actualiza) la entidad a partir del DTO.
    */
    SvPersonaRestringidaEntity save(SvPersonaRestringidaDTO dto);
    ...
    */
    List<SvPersonaRestringidaEntity> saveAll(List<SvPersonaRestringidaDTO> dtos);
}
