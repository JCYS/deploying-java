...
/**
* Interface de servicio para escritura de archivos de SvPersonalEntity
*/
public interface ISvPersonalWriterService extends IDefineColumnReport<SvPersonalDTO> {

    /**
    * Generar archivo CSV a partir de una lista de datos.
    */
    AttachmentData exportToCsv(List<SvPersonalDTO> data);

    /**
    * Generar archivo Excel a partir de una lista de datos.
    */
    AttachmentData exportToExcel(List<SvPersonalDTO> data) throws Exception;
}
