...
/**
* Interface de servicio para escritura de archivos de SvAdjuntoEntity
*/
public interface ISvAdjuntoWriterService extends IDefineColumnReport<SvAdjuntoDTO> {

    /**
    * Generar archivo CSV a partir de una lista de datos.
    */
    AttachmentData exportToCsv(List<SvAdjuntoDTO> data);

    /**
    * Generar archivo Excel a partir de una lista de datos.
    */
    AttachmentData exportToExcel(List<SvAdjuntoDTO> data) throws Exception;
}
