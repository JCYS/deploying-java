...
//---Simple Interface for SvTipoDocumentoIdentidadEntity.

@Data
@ToString
@EqualsAndHashCode
public class SvTipoDocumentoIdentidadResponse {
    ...
    private String expresionRegularCondicion;
    ...
    private List<String> expresionRegularList;
