...
/**
* Repository para SvSolicitudVisitaHistorialEntity
*/
@Repository
public interface ISvSolicitudVisitaHistorialRepository
        extends JpaRepository<SvSolicitudVisitaHistorialEntity, String>, JpaSpecificationExecutor<SvSolicitudVisitaHistorialEntity> {

    @Modifying
    @Transactional
    @Query("UPDATE SvSolicitudVisitaHistorialEntity o SET o.isDeleted = :isDeleted WHERE o.id = :id")
