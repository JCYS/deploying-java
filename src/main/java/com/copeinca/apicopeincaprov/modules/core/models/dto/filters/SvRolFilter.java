...
/**
 * DTO filtro para búsquedas dinámicas de SvRol.
...
@NoArgsConstructor
@AllArgsConstructor
public class SvRolFilter implements Serializable {

    private List<FilterOperation<String>> id;
    private List<FilterOperation<String>> rolName;
    private List<FilterOperation<String>> rolDescription;
