...
/**
* Interface de servicio para lectura de archivos de ViewPersonalReportView
*/
public interface IViewPersonalReportExcelReaderService {

    /**
    * Leer datos desde archivo CSV.
    */
    List<ViewPersonalReportDTO> readFromCsv(InputStream inputStream);

    /**
    * Leer datos desde archivo Excel.
    */
    List<ViewPersonalReportDTO> readFromExcel(InputStream inputStream) throws IOException;
}
