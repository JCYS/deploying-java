...
/**
* Interface de servicio CRUD para SvSolicitudVisitaEventoEntity
* Responsable de las operaciones básicas de creación, actualización y eliminación.
*/
public interface ISvSolicitudVisitaEventoCrudService {

    /**
    * Guarda (crea o actualiza) la entidad a partir del DTO.
    */
    SvSolicitudVisitaEventoEntity save(SvSolicitudVisitaEventoDTO dto);
    ...
    */
    List<SvSolicitudVisitaEventoEntity> saveAll(List<SvSolicitudVisitaEventoDTO> dtos);
}
