...
/**
* Interface de servicio compuesta para SvTipoDocumentoPlanillaEntity
...
*/
public interface ISvTipoDocumentoPlanillaService {
    void saveAll(List<DocPlantillaPojo> lista);
