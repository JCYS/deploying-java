...
/**
* Repository para SvSolicitudVisitaEquipoEntity
*/
@Repository
public interface ISvSolicitudVisitaEquipoRepository
        extends JpaRepository<SvSolicitudVisitaEquipoEntity, String>, JpaSpecificationExecutor<SvSolicitudVisitaEquipoEntity> {

    @Modifying
    @Transactional
    @Query("UPDATE SvSolicitudVisitaEquipoEntity o SET o.isDeleted = :isDeleted WHERE o.id = :id")
    int updateIsDeleted(@Param("isDeleted") boolean isDeleted, @Param("id") String id);

    List<SvSolicitudVisitaEquipoEntity> findAllBySolicitudVisitaId(String solicitudVisitaId);
}
