...
/**
* Interface de servicio CRUD para SvParametroEntity
* Responsable de las operaciones básicas de creación, actualización y eliminación.
*/
public interface ISvParametroCrudService {

    /**
    * Guarda (crea o actualiza) la entidad a partir del DTO.
    */
    SvParametroEntity save(SvParametroDTO dto);
    ...
    */
    List<SvParametroEntity> saveAll(List<SvParametroDTO> dtos);
}
