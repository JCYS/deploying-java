...
/**
* Repository para SvEstadoCalidadAmbientalEntity
*/
@Repository
public interface ISvEstadoCalidadAmbientalRepository
        extends JpaRepository<SvEstadoCalidadAmbientalEntity, String>, JpaSpecificationExecutor<SvEstadoCalidadAmbientalEntity> {

    @Modifying
    @Transactional
    @Query("UPDATE SvEstadoCalidadAmbientalEntity o SET o.isDeleted = :isDeleted WHERE o.id = :id")
