...
/**
* Interface de servicio para escritura de archivos de ViewAdjuntoReportView
*/
public interface IViewAdjuntoReportWriterService extends IDefineColumnReport<ViewAdjuntoReportDTO> {

    /**
    * Generar archivo CSV a partir de una lista de datos.
    */
    AttachmentData exportToCsv(List<ViewAdjuntoReportDTO> data);

    /**
    * Generar archivo Excel a partir de una lista de datos.
    */
    AttachmentData exportToExcel(List<ViewAdjuntoReportDTO> data) throws Exception;
}
