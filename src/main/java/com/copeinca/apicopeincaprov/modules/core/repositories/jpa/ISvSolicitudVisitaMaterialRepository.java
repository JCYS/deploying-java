...
/**
* Repository para SvSolicitudVisitaMaterialEntity
*/
@Repository
public interface ISvSolicitudVisitaMaterialRepository
        extends JpaRepository<SvSolicitudVisitaMaterialEntity, String>, JpaSpecificationExecutor<SvSolicitudVisitaMaterialEntity> {

    @Modifying
    @Transactional
    @Query("UPDATE SvSolicitudVisitaMaterialEntity o SET o.isDeleted = :isDeleted WHERE o.id = :id")
    int updateIsDeleted(@Param("isDeleted") boolean isDeleted, @Param("id") String id);

    List<SvSolicitudVisitaMaterialEntity> findAllBySolicitudVisitaId(String solicitudVisitaId);
}
