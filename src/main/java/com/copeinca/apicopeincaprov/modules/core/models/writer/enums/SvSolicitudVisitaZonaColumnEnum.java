...
/**
* Enum que mapea las columnas del DTO SvSolicitudVisitaZonaDTO con sus índices.
* Utilizado para lectura de archivos CSV y Excel.
*/
@RequiredArgsConstructor
public enum SvSolicitudVisitaZonaColumnEnum implements IExcelColumnPropertiesEnum {

    SOLICITUD_VISITA_ZONA_ID(0, "SOLICITUD_VISITA_ZONA_ID", 400), //
    IS_ACTIVE(1, "IS_ACTIVE", 400), //
    ZONA_ID(2, "ZONA_ID", 400), //
