...
/**
 * DTO filtro para búsquedas dinámicas de SvUsuario.
...
@NoArgsConstructor
@AllArgsConstructor
public class SvUsuarioFilter implements Serializable {

    private List<FilterOperation<String>> id;
    private List<FilterOperation<String>> nombre;
    private List<FilterOperation<String>> apellidos;
    private List<FilterOperation<String>> email;
    private List<FilterOperation<String>> identificadorExterno;
