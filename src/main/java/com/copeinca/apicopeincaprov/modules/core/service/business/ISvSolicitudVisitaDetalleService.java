...
/**
* Interface de servicio compuesta para SvSolicitudVisitaDetalleEntity
...
*/
public interface ISvSolicitudVisitaDetalleService {
    List<SvTrabajadorDTO> getDetail(String id);
