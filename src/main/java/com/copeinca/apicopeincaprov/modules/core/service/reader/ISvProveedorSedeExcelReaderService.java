...
/**
* Interface de servicio para lectura de archivos de SvProveedorSedeEntity
*/
public interface ISvProveedorSedeExcelReaderService {

    /**
    * Leer datos desde archivo CSV.
    */
    List<SvProveedorSedeDTO> readFromCsv(InputStream inputStream);

    /**
    * Leer datos desde archivo Excel.
    */
    List<SvProveedorSedeDTO> readFromExcel(InputStream inputStream) throws IOException;
}
