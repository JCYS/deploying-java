...
/**
* Repository para ViewProveedorReportEntity
*/
@Repository
public interface IViewProveedorReportRepository extends JpaRepository<ViewProveedorReportView, String>, JpaSpecificationExecutor<ViewProveedorReportView> {
