...
/**
* Repository para ViewPersonaRestringidaReportEntity
*/
@Repository
public interface IViewPersonaRestringidaReportRepository
        extends JpaRepository<ViewPersonaRestringidaReportView, String>, JpaSpecificationExecutor<ViewPersonaRestringidaReportView> {
