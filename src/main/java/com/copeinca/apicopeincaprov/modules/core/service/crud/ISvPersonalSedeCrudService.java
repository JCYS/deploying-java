...
/**
* Interface de servicio CRUD para SvPersonalSedeEntity
* Responsable de las operaciones básicas de creación, actualización y eliminación.
*/
public interface ISvPersonalSedeCrudService {

    /**
    * Guarda (crea o actualiza) la entidad a partir del DTO.
    */
    SvPersonalSedeEntity save(SvPersonalSedeDTO dto);
    ...
    */
    List<SvPersonalSedeEntity> saveAll(List<SvPersonalSedeDTO> dtos);
}
