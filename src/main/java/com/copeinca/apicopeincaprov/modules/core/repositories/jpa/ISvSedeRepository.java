...
/**
* Repository para SvSedeEntity
*/
@Repository
public interface ISvSedeRepository extends JpaRepository<SvSedeEntity, String>, JpaSpecificationExecutor<SvSedeEntity> {

    @Modifying
    @Transactional
    @Query("UPDATE SvSedeEntity o SET o.isDeleted = :isDeleted WHERE o.id = :id")
    int updateIsDeleted(@Param("isDeleted") boolean isDeleted, @Param("id") String id);

    List<SvSedeEntity> findByName(String name);
}
