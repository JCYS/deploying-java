...
/**
* Interface de servicio CRUD para SvProveedorSedeEntity
* Responsable de las operaciones básicas de creación, actualización y eliminación.
*/
public interface ISvProveedorSedeCrudService {

    /**
    * Guarda (crea o actualiza) la entidad a partir del DTO.
    */
    SvProveedorSedeEntity save(SvProveedorSedeDTO dto);
    ...
    */
    List<SvProveedorSedeEntity> saveAll(List<SvProveedorSedeDTO> dtos);
}
