...
/**
* Repository para ViewSolicitudVisitaReportEntity
*/
@Repository
public interface IViewSolicitudVisitaReportRepository
        extends JpaRepository<ViewSolicitudVisitaReportView, String>, JpaSpecificationExecutor<ViewSolicitudVisitaReportView> {
