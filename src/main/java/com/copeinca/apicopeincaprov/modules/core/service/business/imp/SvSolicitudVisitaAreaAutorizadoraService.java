...
/**
* Implementación del service para SvSolicitudVisitaAreaAutorizadoraEntity
* Extiende de las implementaciones especializadas para reutilizar funcionalidad
*/
@Slf4j
@Service
@RequiredArgsConstructor
public class SvSolicitudVisitaAreaAutorizadoraService implements ISvSolicitudVisitaAreaAutorizadoraService {
