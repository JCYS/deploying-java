...
/**
* Repository para ViewAdjuntoReportEntity
*/
@Repository
public interface IViewAdjuntoReportRepository extends JpaRepository<ViewAdjuntoReportView, String>, JpaSpecificationExecutor<ViewAdjuntoReportView> {
