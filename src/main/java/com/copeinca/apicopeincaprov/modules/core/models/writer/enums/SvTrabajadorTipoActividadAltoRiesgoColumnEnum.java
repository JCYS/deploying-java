...
/**
* Enum que mapea las columnas del DTO SvTrabajadorTipoActividadAltoRiesgoDTO con sus índices.
* Utilizado para lectura de archivos CSV y Excel.
*/
@RequiredArgsConstructor
public enum SvTrabajadorTipoActividadAltoRiesgoColumnEnum implements IExcelColumnPropertiesEnum {

    TRABAJADOR_TIPO_ACTIVIDAD_ALTO_RIESGO_ID(0, "TRABAJADOR_TIPO_ACTIVIDAD_ALTO_RIESGO_ID", 400), //
    TRABAJADOR_ID(1, "TRABAJADOR_ID", 400), //
