...
/**
* Interface de servicio para lectura de archivos de SvTrabajadorEntity
*/
public interface ISvTrabajadorExcelReaderService {

    /**
    * Leer datos desde archivo CSV.
    */
    List<SvTrabajadorDTO> readFromCsv(InputStream inputStream);

    /**
    * Leer datos desde archivo Excel.
    */
    List<SvTrabajadorDTO> readFromExcel(InputStream inputStream) throws IOException;
}
