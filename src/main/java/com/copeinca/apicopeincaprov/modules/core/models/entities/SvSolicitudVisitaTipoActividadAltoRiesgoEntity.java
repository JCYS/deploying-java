...
@Entity
@Table(name = "SV_SOLICITUD_VISITA_TIPO_ACTIVIDAD_ALTO_RIESGO")
public class SvSolicitudVisitaTipoActividadAltoRiesgoEntity extends BaseEntity implements Serializable {

    // -----------------------------------------------------------------
    // Attributes
    // -----------------------------------------------------------------

    @Column(name = "SOLICITUD_VISITA_TIPO_ACTIVIDAD_ALTO_RIESGO_ID", length = 36)
