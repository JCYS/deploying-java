...
/**
* Implementación del service para ViewSolicitudVisitaReportView
* Extiende de las implementaciones especializadas para reutilizar funcionalidad
*/
@Slf4j
@Service
@RequiredArgsConstructor
public class ViewSolicitudVisitaReportService implements IViewSolicitudVisitaReportService {
