...
/**
* Enum que mapea las columnas del DTO SvPersonalSedeDTO con sus índices.
* Utilizado para lectura de archivos CSV y Excel.
*/
@RequiredArgsConstructor
public enum SvPersonalSedeColumnEnum implements IExcelColumnPropertiesEnum {

    PERSONAL_SEDE_ID(0, "PERSONAL_SEDE_ID", 400), //
    PERSONAL_ID(1, "PERSONAL_ID", 400), //
