...
/**
 * DTO filtro para búsquedas dinámicas de SvTipoDocumentoPlanilla.
...
@NoArgsConstructor
@AllArgsConstructor
public class SvTipoDocumentoPlanillaFilter implements Serializable {
    ...
    private List<FilterOperation<Boolean>> obligatorio;
    private List<FilterOperation<Boolean>> vencimiento;
