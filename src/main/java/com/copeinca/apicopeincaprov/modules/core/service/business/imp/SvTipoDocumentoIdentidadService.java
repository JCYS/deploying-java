...
/**
* Implementación del service para SvTipoDocumentoIdentidadEntity
* Extiende de las implementaciones especializadas para reutilizar funcionalidad
*/
@Slf4j
@Service
@RequiredArgsConstructor
public class SvTipoDocumentoIdentidadService implements ISvTipoDocumentoIdentidadService {
