...
/**
* Interface de servicio para escritura de archivos de SvSedeEntity
*/
public interface ISvSedeWriterService extends IDefineColumnReport<SvSedeDTO> {

    /**
    * Generar archivo CSV a partir de una lista de datos.
    */
    AttachmentData exportToCsv(List<SvSedeDTO> data);

    /**
    * Generar archivo Excel a partir de una lista de datos.
    */
    AttachmentData exportToExcel(List<SvSedeDTO> data) throws Exception;
}
