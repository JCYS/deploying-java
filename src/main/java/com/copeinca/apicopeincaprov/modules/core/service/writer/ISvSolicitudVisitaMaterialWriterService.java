...
/**
* Interface de servicio para escritura de archivos de SvSolicitudVisitaMaterialEntity
*/
public interface ISvSolicitudVisitaMaterialWriterService extends IDefineColumnReport<SvSolicitudVisitaMaterialDTO> {

    /**
    * Generar archivo CSV a partir de una lista de datos.
    */
    AttachmentData exportToCsv(List<SvSolicitudVisitaMaterialDTO> data);

    /**
    * Generar archivo Excel a partir de una lista de datos.
    */
    AttachmentData exportToExcel(List<SvSolicitudVisitaMaterialDTO> data) throws Exception;
}
