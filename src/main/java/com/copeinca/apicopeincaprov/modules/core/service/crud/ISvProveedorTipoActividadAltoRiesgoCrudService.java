...
/**
* Interface de servicio CRUD para SvProveedorTipoActividadAltoRiesgoEntity
* Responsable de las operaciones básicas de creación, actualización y eliminación.
*/
public interface ISvProveedorTipoActividadAltoRiesgoCrudService {

    /**
    * Guarda (crea o actualiza) la entidad a partir del DTO.
    */
    SvProveedorTipoActividadAltoRiesgoEntity save(SvProveedorTipoActividadAltoRiesgoDTO dto);
    ...
    */
    List<SvProveedorTipoActividadAltoRiesgoEntity> saveAll(List<SvProveedorTipoActividadAltoRiesgoDTO> dtos);
}
