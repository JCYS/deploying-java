...
/**
* Interface de servicio para lectura de archivos de SvSolicitudVisistaEntity
*/
public interface ISvSolicitudVisistaExcelReaderService {

    /**
    * Leer datos desde archivo CSV.
    */
    List<SvSolicitudVisistaDTO> readFromCsv(InputStream inputStream);

    /**
    * Leer datos desde archivo Excel.
    */
    List<SvSolicitudVisistaDTO> readFromExcel(InputStream inputStream) throws IOException;
}
