...
/**
* Enum que mapea las columnas del DTO SvTipoActividadAltoRiesgoDTO con sus índices.
* Utilizado para lectura de archivos CSV y Excel.
*/
@RequiredArgsConstructor
public enum SvTipoActividadAltoRiesgoColumnEnum implements IExcelColumnPropertiesEnum {

    TIPO_ACTIVIDAD_ALTO_RIESGO_CODE(0, "TIPO_ACTIVIDAD_ALTO_RIESGO_CODE", 400), //
