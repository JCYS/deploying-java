...
/**
* Interface de servicio para escritura de archivos de SvSolicitudVisitaAreaAutorizadoraEntity
*/
public interface ISvSolicitudVisitaAreaAutorizadoraWriterService extends IDefineColumnReport<SvSolicitudVisitaAreaAutorizadoraDTO> {

    /**
    * Generar archivo CSV a partir de una lista de datos.
    */
    AttachmentData exportToCsv(List<SvSolicitudVisitaAreaAutorizadoraDTO> data);

    /**
    * Generar archivo Excel a partir de una lista de datos.
    */
    AttachmentData exportToExcel(List<SvSolicitudVisitaAreaAutorizadoraDTO> data) throws Exception;
}
